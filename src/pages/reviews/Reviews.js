...
function Reviews(){
    ...
    <>
        <div className="fullReviews">
            <Navbar />
            <div className={hover? "reviewsTopHover" : "reviewsTop"}  onMouseOut={() => {setHover(false)}} onMouseOver={() => {setHover(true)}}>
            ...
            <div data-aos ="fade-right" data-aos-duration="1000" className="reviewsHeading" onMouseOut={() => {setHover(false)}} onMouseOver={() => {setHover(true)}}>
            ...
            <Slider {...settings} className="reviewPhoto" >
